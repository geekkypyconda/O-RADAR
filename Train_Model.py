...
def run_model(model_num, dataset_path,X_train,y_train,X_test,y_test):
    ...
    if model_num == 1:
        ...
        model = Simple_LSTM(num_labels=number_of_classes, timesteps=1, number_of_features=X_train.shape[1],learning_rate=0.01,epochs=100, batch_size=32, classification_type="multi-class",save_name=save_name)
    elif model_num == 12:
